...
RSpec.describe ApartmentSearchService do
  context 'search' do
    ...
    it 'should return all without search query' do
      expect(ApartmentSearchService.new(search_params: {}).execute).to match_array([apartment_villa, apartment_flat_2bhk, apartment_flat_3bhk, apartment_studio])
    end
